...
lab:
  ...
  description: Extend agent capabilities by integrating Model Context Protocol (MCP)
    server tools.
  level: 300
  duration: 60
  islab: true
...
1. In the Explorer view, navigate to the **Labfiles/03-mcp-integration/Python** folder to find the starter code for this exercise.
